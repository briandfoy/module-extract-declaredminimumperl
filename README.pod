...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Module-Extract-DeclaredMinimumPerl> or 
L<MetaCPAN|http://www.metacpan.org/module/Module::Extract::DeclaredMinimumPerl>:

=over 4

=item *	L<http://search.cpan.org/dist/Module-Extract-DeclaredMinimumPerl>

=item *	L<http://www.metacpan.org/module/Module::Extract::DeclaredMinimumPerl>
